...
| Projects | `src/components/Projects.tsx` + `ProjectCard.tsx` | `src/data/projects.ts` | 🟡 2 of 3 real (project-1 fully done; project-2 text real, image slots pending) |
